...
try {
        ...
        if (accessories && accessoriesArray.length !== accessories.length) {
            return res.status(404).json({ result: false, error: "One or more accessories not found" });
        }
        ...
        return res.status(404).json({ result: false, error: "One or more options not found" });
        }
