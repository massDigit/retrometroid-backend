...
router.post('/addProduct', async (req, res) => {
    try {
        const { name, type, price, stockQuantity, description, categorie, 
        // Noms des options 
        coqueName, buttonName, padsName, laniereName, stickersName, batterieName, screenName, 
        // Accessoires par nom
        sacoche, screen_shield, silicone_shield, 
        // Couleurs pour chaque option
        coqueColor, buttonColor, padsColor, laniereColor, stickersColor, batterieColor, screenColor, } = req.body;
